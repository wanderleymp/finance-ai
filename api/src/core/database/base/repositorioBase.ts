...
// Tipo para permitir indexação dinâmica no PrismaClient
type PrismaClientWithDynamicIndex = PrismaClient & {
  [key: string]: any;
};
...
export abstract class RepositorioBase<T, ID> implements IRepository<T, ID> {
   ...
   */
  constructor(
    protected readonly prisma: PrismaClientWithDynamicIndex,
